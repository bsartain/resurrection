      ...
      <div className="s-header__block">
        {/* <div className="s-header__logo">
          <Link href="/" className="logo">
            <img src="/images/logo.svg" alt=" Anglican Church" />
          </Link>
        </div> */}

        <button className="s-header__menu-toggle" onClick={() => setIsMenuOpen(!isMenuOpen)} aria-label="Toggle menu">
          <span>Browse</span>
        </button>
      </div>

      <nav className={`s-header__nav ${isMenuOpen ? "is-visible" : ""}`}>
        <button className="s-header__nav-close-btn" onClick={() => setIsMenuOpen(false)} aria-label="Close menu">
          <span>Close</span>
        </button>

        {/* <div className="s-header__nav-logo">
          <Link href="/">
            <img src="/images/logo.svg" alt="Maillard" />
          </Link>
        </div> */}

        <ul className="s-header__nav-links">
          ...
          <li>
            <Link href="/menu">
              <span onClick={() => setIsMenuOpen(false)}>Menu</span>
            </Link>
          </li>
          <li>
            <Link href="/about">
              <span onClick={() => setIsMenuOpen(false)}>About</span>
            </Link>
          </li>
          <li>
            <Link href="/reservations">
              <span onClick={() => setIsMenuOpen(false)}>Reservations</span>
            </Link>
          </li>
        </ul>

        <div className="s-header__nav-bottom">
          <h6>Phone</h6>
          <div className="s-header__booking">
            <div className="s-header__booking-no">
              <a href="tel:+2135551234">(213) 555-1234</a>
            </div>
          </div>

          {/* Social icons */}
          <ul className="s-header__nav-social social-list">
            <li>
              <a href="#0">
                <svg
